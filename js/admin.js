...
/* =========================================================
   BULK URL NORMALIZATION
========================================================= */

function normalizeImportURL(
  value
) {
...
${error.code || error.message}`,
  ...
  for (
    ...
    if (
      ...
      errors.push(
        `العنصر ${i + 1}: البيانات ليست Object`
      );
    ...
    if (
      ...
      errors.push(
        `العنصر ${i + 1}: الرابط موجود مسبقًا`
      );
    ...
    if (
      ...
      errors.push(
        `العنصر ${i + 1}: الرابط مكرر داخل الاستيراد`
      );
  ...
  try {
    ...
    for (
      ...
      msg(
        ...
        `جاري الاستيراد...
تم حفظ ${added} من ${validItems.length}`,
